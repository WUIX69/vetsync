...
const productCategorySection = $("section.categories-table");
const categoriesTableBody = productCategorySection.find("table tbody");
    ...
    productCategoriesAjax({
        ...
        success: function (response) {
            ...
            categories.forEach((item) => {
                categoriesHTML += `
                    <tr class="product-category-item" data-category-id="${
                        item.id
                    }">
...
function deleteProductCategory(categoryId = null) {
    if (!categoryId) return false;
