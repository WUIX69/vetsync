...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET') {
        ...
        //         'dob' => Formatters::dateToMDY($user['dob']),
        //         'location' => $user['location'] ?? '...',
        //         'profile' => media($user['uuid']),
        //         'created_at' => Formatters::timeAgo($user['created_at']),
        //     ];
        // }, $users['data'] ?? []);
        // // Needed for DataTable
        // $users['recordsTotal'] = count($users['data']) ?? 0;
        // $users['recordsFiltered'] = count($users['data']) ?? 0;
