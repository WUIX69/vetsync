                        ...
                        <div class="col-lg-4">
                            <div class="service-card card">
                                <div class="card-img">
                                    ...
                                    <img src="<?= asset('img/contents/services/deworm.jpg'); ?>"
                                        alt="Vaccination Services">
                                    <div class="service-tag">
                                        <span class="ui primary tag label">Featured</span>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="service-details">
                                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt, sapiente?
                                        </p>
                                        <p>Duration: 20-30 minutes</p>
                                    </div>
                                    <div class="service-meta">
                        ...
                        <div class="col-lg-4">
                            <div class="service-card card">
                                <div class="card-img">
                                    ...
                                    <img src="<?= asset('img/contents/services/consultation.png'); ?>"
                                        alt="Vaccination Services">
                                    <div class="service-tag">
                                        <span class="ui primary tag label">Featured</span>
                                    </div>
                        ...
                        <div class="col-lg-4">
                            <div class="service-card card">
                                <div class="card-img">
                                    ...
                                    <img src="<?= asset('img/contents/services/medication.jpg'); ?>"
                                        alt="Vaccination Services">
                                    <div class="service-tag">
                                        <span class="ui primary tag label">Featured</span>
                                    </div>
                        ...
                        <div class="col-lg-4">
                            <div class="service-card card">
                                <div class="card-img">
                                    ...
                                    <img src="<?= asset('img/contents/services/laboratory.jpg'); ?>"
                                        alt="Vaccination Services">
                                    <div class="service-tag">
                                        <span class="ui primary tag label">Featured</span>
                                    </div>
                        ...
                        <div class="col-lg-4">
                            <div class="service-card card">
                                <div class="card-img">
                                    ...
                                    <img src="<?= asset('img/contents/services/home.jpg'); ?>"
                                        alt="Vaccination Services">
                                    <div class="service-tag">
                                        <span class="ui primary tag label">Featured</span>
                                    </div>
                        ...
                        <div class="col-lg-4">
                            <div class="service-card card">
                                <div class="card-img">
                                    ...
                                    <img src="<?= asset('img/contents/services/whelping.jpg'); ?>"
                                        alt="Vaccination Services">
                                    <div class="service-tag">
                                        <span class="ui primary tag label">Featured</span>
                                    </div>
