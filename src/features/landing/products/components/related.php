...
<div class="section-container">
    <section class="section-wrapper related-products">
        <div class="container">
            <div class="related-tag">RELATED PRODUCTS</div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="related-card">
                        <div class="related-card-image">
                            <img src="../../../../public/assets/img/contents/services/vaccination.jpg"
                                alt="Vaccinations">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="related-card">
                        <div class="related-card-image">
                            <img src="../../../../public/assets/img/contents/services/accessories.jpg"
                                alt="Dental Care">
                        </div>
                        <div class="related-card-content">
