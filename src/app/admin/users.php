                    ...
                    <div class="section-container">
                        ...
                        <div class="section-wrapper box new-users">
                            <div class="d-flex flex-wrap justify-content-around">
                                <div class="user">
                                    <img src="../../../public/assets/img/profiles/user-1.jpg" class="rounded-circle"
                                        alt="User avatar" />
                                    <label class="mt-2 name">John Doe</label>
                                    <small class="text-muted time-ago">2 mins ago</small>
                                </div>
                                <div class="user">
                                    <img src="../../../public/assets/img/profiles/user-2.jpg" class="rounded-circle"
                                        alt="User avatar" />
                                    <label class="mt-2">John Doe</label>
                                    <small class="text-muted">5 mins ago</small>
                                </div>
                                <div class="user">
                                    <img src="../../../public/assets/img/profiles/user-3.jpg" class="rounded-circle"
                                        alt="User avatar" />
                                    <label class="mt-2">John Doe</label>
                                    <small class="text-muted">15 mins ago</small>
                                </div>
                                <div class="user">
                                    <img src="../../../public/assets/img/profiles/user-4.jpg" class="rounded-circle"
                                        alt="User avatar" />
                                    <label class="mt-2">John Doe</label>
                        ...
                        <div class="profile">
                            ...
                            <div class="profile-photo">
                                <img class="rounded-circle" width="37"
                                    src="../../../public/assets/img/profiles/profile.jpg" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rsection-container box">
                        ...
                        <div class="rsection-wrapper">
                            <div class="ui feed mt-4" id="userActivityFeed">
                                <div class="event">
                                    <div class="label">
                                        <img src="../../../public/assets/img/avatars/elliot.jpg"
                                ...
                                <div class="event">
                                    <div class="label">
                                        <img src="../../../public/assets/img/avatars/helen.jpg"
                                            class="ui avatar image" />
                                    </div>
                                    <div class="content">
                                        <div class="summary">
                                ...
                                <div class="event">
                                    <div class="label">
                                        <img src="../../../public/assets/img/avatars/jenny.jpg"
                                            class="ui avatar image" />
                                    </div>
                                    <div class="content">
                                        <div class="summary">
                                ...
                                <div class="event">
                                    <div class="label">
                                        <img src="../../../public/assets/img/avatars/justen.jpg"
                                            class="ui avatar image" />
                                    </div>
                                    <div class="content">
                                        <div class="summary">
